...
//            if ("/register".equals(path) || "/authenticate".equals(path) || "/address/visitor".equals(path)) {
...
//            }
            if (StringUtils.hasText(authHeader)) {
                ...
                if (user.isPresent()) {
                    ...
                    response.sendError(HttpServletResponse.SC_BAD_REQUEST, "This user does not exist.");
                }
            ...
            response.sendError(HttpServletResponse.SC_BAD_REQUEST, "Bad header");

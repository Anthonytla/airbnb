...
export const UserCard = ({ user }: Props) => {
  ...
  switch (user.role) {
    ...
    case "ROLE_VOYAGEUR":
      badge = (
        <div className="rounded text-center bg-gradient-to-t from-green-500 to-green-300 text-white min-w-[50px] max-w-[70px] mb-2">
          traveler
        </div>
      );
      break;
    case "ROLE_HOTE":
      badge = (
        <div className="rounded text-center bg-gradient-to-t from-blue-500 to-blue-300 text-white min-w-[50px] max-w-[50px] mb-2">
          host
        </div>
      );
      break;
